...
urlpatterns = patterns('',
                       ...
                       url(r'^inline/test/(?P<course_uuid>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/(?P<schedule_key>[a-f0-9]{4,8})/$',views.assessment_inline, name="student-assessment-test"),
                       url(r'^end/test/(?P<course_uuid>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/(?P<schedule_key>[a-f0-9]{4,8})/$',views.assesment_end_test, name="student-ent-test"),
